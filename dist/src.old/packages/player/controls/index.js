...
var Controls = (function (_super) {
    ...
    function Controls(props) {
        ...
        _this.changeIsPlaying = function () {
            _this.setState({ isPlaying: !DZ.player.isPlaying() }, function () { return (DZ.player.isPlaying() ? DZ.player.pause() : DZ.player.play()); });
        };
    ...
    Controls.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "no_controls" },
            ...
            React.createElement("button", null,
                React.createElement(rewind_1.default, { onClick: this.props.appState.playerPrev() })),
            React.createElement("button", { onClick: this.changeIsPlaying },
                React.createElement("img", { src: this.props.appState.playerIsPlaying ? "/assets/img/pause.png" : const_1.default.play, alt: "" })),
            React.createElement("button", null,
                React.createElement(forward_1.default, { onClick: function () { _this.props.appState.playerNext(); } })),
            React.createElement("button", null,
