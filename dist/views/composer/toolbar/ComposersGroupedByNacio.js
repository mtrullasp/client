...
var ComposersGroupedByNacio = (function (_super) {
    __extends(ComposersGroupedByNacio, _super);
    function ComposersGroupedByNacio(props, context) {
    ...
    return ComposersGroupedByNacio;
}(React.Component));
