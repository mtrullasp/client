...
var MyCollection = (function (_super) {
    ...
    MyCollection.prototype.render = function () {
        ...
        return (React.createElement(semantic_ui_react_1.Grid, { columns: 16, relaxed: false },
            ...
            React.createElement(semantic_ui_react_1.Grid.Row, { columns: 16 },
                React.createElement(semantic_ui_react_1.Grid.Column, null, this.props.asideLeftContent),
