                                    ...
                                    React.createElement(react_flexbox_grid_1.Row, null,
                                            ...
                                            React.createElement(MaxHeightContainer_1.default, null,
                                                React.createElement(react_custom_scrollbars_1.default, { autoHide: true, style: { width: "100%" } },
                                                    React.createElement(ComposerItemInfo_1.default, { caption: "Biographical Timeline" },
                                                        React.createElement(MyTimeLine, { onClick: function (item) {
                                        ...
                                        React.createElement(react_flexbox_grid_1.Col, { lg: 4 },
                                            React.createElement(ComposerItemInfo_1.default, { caption: "Top works", onMaximize: function () {
                                                ...
                                                React.createElement(ListTopWorks, { topTracks: this.props.appState.composerTopTracks, trackPlaying: this.props.appState.topTrackIsPlaying, color: this.props.appState.activeComposerColor, onSelect: function (track) {
                                                        _this.props.appState.toggleTrack(track.id);
                                                    } }),
                                                React.createElement(ActionButton, { onClick: function () { }, style: { width: "50%" } },
                                            ...
                                            React.createElement(react_flexbox_grid_1.Row, null,
                                                React.createElement(react_flexbox_grid_1.Col, { lg: 6 },
                                                    React.createElement(ComposerItemInfo_1.default, { caption: "Following" },
                                                        React.createElement(ListComposerSocial, { color: this.props.appState.activeComposerColor, onSelect: this.handleSocialSelect, composers: this.props.appState.activeComposerFollowing }))),
                                                React.createElement(react_flexbox_grid_1.Col, { lg: 6 },
                                                    React.createElement(ComposerItemInfo_1.default, { caption: "Followers" },
                                                        React.createElement(ListComposerSocial, { color: this.props.appState.activeComposerColor, onSelect: this.handleSocialSelect, composers: this.props.appState.activeComposerFollowers }))))))))))))));
    };
