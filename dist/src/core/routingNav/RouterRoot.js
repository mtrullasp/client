...
var ComposerOne_1 = require("../../views/composer/item/ComposerOne");
var RouterRoot = (function (_super) {
    ...
    RouterRoot.prototype.render = function () {
        return (React.createElement(react_router_1.Switch, null,
            ...
            React.createElement(react_router_1.Route, { path: constants_1.ROUTE_COMPOSERS_ITEM, exact: true, component: ComposerOne_1.default }),
