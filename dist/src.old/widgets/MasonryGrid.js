...
var MasonryGrid = (function (_super) {
    ...
    function MasonryGrid(props, context) {
        ...
        mobx_1.reaction(function () { return props.appState.eventKey; }, function (key) {
            if (props.appState.isActiveInput) {
                return;
            }
            switch (key) {
                case constants_1.ARROW_UP:
                    break;
                case constants_1.ARROW_DOWN:
                    break;
                case constants_1.ARROW_LEFT:
                    break;
                case constants_1.ARROW_RIGHT:
                    break;
            }
        });
        return _this;
    ...
    MasonryGrid.prototype.render = function () {
        ...
        return (React.createElement(react_container_dimensions_1.default, null, function (_a) {
            ...
            return _this.props.gridEngine === "stonecutter" ? (React.createElement("div", { style: __assign({}, _this.props.style) },
                React.createElement(SpringGrid, { component: "ul", columns: _this.props.numColumns, columnWidth: width / _this.props.numColumns, gutterWidth: _this.props.gutter, gutterHeight: _this.props.gutter, itemHeight: columnHeight, springConfig: {
                ...
                }, enableLightbox: true, enableImageSelection: false, onClickThumbnail: function (index) {
