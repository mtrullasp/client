...
var MyPerformerItems_1 = require("./MyPerformerItems");
...
var MyPerformers = (function (_super) {
    __extends(MyPerformers, _super);
    function MyPerformers(props, context) {
        var _this = _super.call(this, props, context) || this;
        _this.props.appState.idInstrumentArtist = _this.props.match.params.idInstrument;
        _this.props.appState.activeIdInstrument = _this.props.appState.idInstrumentArtist;
        return _this;
    }
    MyPerformers.prototype.render = function () {
        var _this = this;
        ...
        var content;
        content = (React.createElement(MyPerformerItems_1.default, { numberOfOclumns: NUMBER_COLS, items: this.props.appState.userPerformers, onClick: function (p) {
                _this.props.appState.albums.searchByContributor(p.name);
            } }));
    ...
    MyPerformers.defaultProps = {
        fontSize: 40
    };
    MyPerformers = __decorate([
        mobx_react_1.inject("appState"),
        mobx_react_1.observer
    ], MyPerformers);
    return MyPerformers;
}(React.Component));
exports.default = react_router_1.withRouter(withStyles_1.default(styles)(MyPerformers));
