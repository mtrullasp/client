...
var QuotesCarousel = (function (_super) {
    ...
    QuotesCarousel.prototype.render = function () {
        ...
        var items = this.props.appState.activeComposerQuotes.map(function (q) {
            return (React.createElement("div", null,
                React.createElement(TextFit_1.default, { style: { height: 120 }, maxFontSize: 50, text: q.content.trimRight() + " " }),
