...
let PerformerCollection = class
PerformerCollection extends React.Component {
    ...
    */
    render() {
        ...
        const items = (width, height) => this.props.performerStore.performersRaw.map((pr, index) => {
            let contentBase = (opacity) => {
                return (<div key={pr.idMN} onClick={() => {

                    this.props.performerStore.activePerformerId = pr.idMN;
                    this.props.history.push(constants_1.ROUTE_ALBUMS_COLLECTION);
                }}>
              <semantic_ui_react_1.Image fluid={true} src={"http://127.0.1.0/PictureArtist/" + pr.idMN + ".jpg"} alt={pr.nameMN} style={{
                    height: width,
                    width: width,
        ...
        const images = this.props.performerStore.performersRaw.map((performer, index) => {
            return {
        ...
        return (items && (<MaxHeightContainer_1.default style={{
          ...
          <div>
            ...
            this.props.performerStore.activePerformerId = item.performer.idMN;
            this.props.history.push(constants_1.ROUTE_ALBUMS_COLLECTION);
...
//# sourceMappingURL=PerformerCollection.jsx.map
